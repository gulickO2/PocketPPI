...
#include <EEPROM.h>
#include <HardwareSerial.h>  // CHANGED: Replace BluetoothSerial with HardwareSerial
...
// ADS-B UART Interface (REPLACES Bluetooth)
extern HardwareSerial ADSB_Serial;
extern TaskHandle_t xHandleADSBReaderTask;
